...
<body <?php body_class(); ?>>
    ...
    <!-- Profile Dropdown -->
    <?php if ( is_user_logged_in() || ! empty( $_COOKIE['auth_id'] ) || $is_web_app ) : ?>
    <div id="profile-dropdown-container" style="<?php echo (!is_user_logged_in() && empty($_COOKIE['auth_id'])) ? 'display: none;' : ''; ?>">
