...
?>>
    ...
    // Always render the container for web app (so JS can control it), but hide if no auth
    if ( $auth_exists || $is_web_app ) : ?>
    <div id="profile-dropdown-container" style="<?php echo !$auth_exists ? 'display: none;' : ''; ?>">
