<?php
   ...
   add_action('template_redirect', function() {
    ...
    function custom_google_signin_button() {
        ...
        <div class="google-signin-container">
            <button id="google-signin" type="button" class="google-signin-button">
                <svg class="google-icon" width="20" height="20" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
    ...
    /**
     * Add Google signin button after the login form with proper separator
     */
    add_action('login_footer', 'custom_add_google_signin_section');
    function custom_add_google_signin_section() {
        ?>
        <div id="oauth-signin-section">
            <?php custom_google_signin_button(); ?>
        </div>
        <script>
        // Move OAuth section after the form
        document.addEventListener('DOMContentLoaded', function() {
            const loginForm = document.getElementById('loginform');
            const oauthSection = document.getElementById('oauth-signin-section');
            if (loginForm && oauthSection) {
                // Insert directly after form, maintaining proper spacing
                loginForm.parentNode.insertBefore(oauthSection, loginForm.nextSibling);
                // Add spacing between form and OAuth section
